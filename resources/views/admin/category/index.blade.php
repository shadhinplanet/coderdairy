        ...
        <div class="card col-span-4 xl:col-span-1">
            ...
            <table class="table-auto w-full text-left">
                ...
                <tbody class="text-gray-600">
                        ...
                        <tr>
                            ...
                            <td class="border border-l-0 px-4 py-2 ">
                                <div class="capitalize flex space-x-2 text-xs">
                                    <a href="{{ route('category.edit', $category) }}" class="btn-bs-primary">Edit</a>
                                    <form action="{{ route('category.destroy', $category) }}" method="POST" onsubmit="return confirm('Do you want to delete?');">
                                        @csrf
                                        @method('DELETE')
                    ...
                    @empty
                        <tr>
                            <td class="border border-l-0 px-4 py-2 text-center text-red-500" colspan="5">No Category Found
                            </td>
                        </tr>
                    @endforelse
